...
--
-- Indeksy dla tabeli `vmcs_logs`
--
ALTER TABLE `vmcs_logs`
  ADD PRIMARY KEY (`id`);

--
-- Indeksy dla tabeli `vmcs_news`
--
...
--
-- Indeksy dla tabeli `vmcs_pages`
--
ALTER TABLE `vmcs_pages`
  ADD PRIMARY KEY (`id`);

--
-- Indeksy dla tabeli `vmcs_purchases`
--
...
--
-- Indeksy dla tabeli `vmcs_servers`
--
ALTER TABLE `vmcs_servers`
  ADD PRIMARY KEY (`id`);

--
-- Indeksy dla tabeli `vmcs_services`
--
ALTER TABLE `vmcs_services`
  ADD PRIMARY KEY (`id`);

--
-- Indeksy dla tabeli `vmcs_users`
--
ALTER TABLE `vmcs_users`
  ADD PRIMARY KEY (`id`);

--
-- Indeksy dla tabeli `vmcs_vouchers`
--
